...
Esse será o Git onde desenvolveremos o nosso projeto!

Assista os videos para introdução e entender como utilizar:
...
(O ultimo é uma playlist para melhor entendimento)
